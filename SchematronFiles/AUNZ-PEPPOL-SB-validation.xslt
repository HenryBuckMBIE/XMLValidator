...
<!--SCHEMA SETUP-->
<xsl:template match="/">
<svrl:schematron-output title="Rules for AUNZ Self Billing " schemaVersion="iso" xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
<xsl:comment>
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="//*[not(*) and not(normalize-space())]" priority="1000" mode="M15">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="ubl-creditnote:CreditNote | ubl-invoice:Invoice" priority="1015" mode="M16">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="starts-with(normalize-space(cbc:CustomizationID/text()), 'urn:cen.eu:en16931:2017#conformant#urn:fdc:peppol.eu:2017:poacc:selfbilling:international:aunz:3.0')">
...
<xsl:apply-templates select="@*|*" mode="M16"/>
	...
	<!--RULE -->
<xsl:template match="cbc:TaxCurrencyCode" priority="1014" mode="M16">
...
<xsl:apply-templates select="@*|*" mode="M16"/>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingCustomerParty/cac:Party" priority="1013" mode="M16">
...
<xsl:apply-templates select="@*|*" mode="M16"/>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingSupplierParty/cac:Party" priority="1012" mode="M16">
...
<xsl:apply-templates select="@*|*" mode="M16"/>
	...
	<!--RULE -->
<xsl:template match="ubl-invoice:Invoice/cac:AllowanceCharge | ubl-invoice:Invoice/cac:InvoiceLine/cac:AllowanceCharge | ubl-creditnote:CreditNote/cac:AllowanceCharge | ubl-creditnote:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge" priority="1009" mode="M16">
...
<xsl:apply-templates select="@*|*" mode="M16"/>
	...
	<!--RULE -->
<xsl:template match="ubl-invoice:Invoice[cac:InvoicePeriod/cbc:StartDate]/cac:InvoiceLine/cac:InvoicePeriod/cbc:StartDate | ubl-creditnote:CreditNote[cac:InvoicePeriod/cbc:StartDate]/cac:CreditNoteLine/cac:InvoicePeriod/cbc:StartDate" priority="1007" mode="M16">
...
<xsl:apply-templates select="@*|*" mode="M16"/>
	...
	<!--RULE -->
<xsl:template match="ubl-invoice:Invoice[cac:InvoicePeriod/cbc:EndDate]/cac:InvoiceLine/cac:InvoicePeriod/cbc:EndDate | ubl-creditnote:CreditNote[cac:InvoicePeriod/cbc:EndDate]/cac:CreditNoteLine/cac:InvoicePeriod/cbc:EndDate" priority="1006" mode="M16">
...
<xsl:apply-templates select="@*|*" mode="M16"/>
	...
	<!--RULE -->
<xsl:template match="cac:InvoiceLine | cac:CreditNoteLine" priority="1005" mode="M16">
...
<xsl:apply-templates select="@*|*" mode="M16"/>
	...
	<!--RULE -->
<xsl:template match="cac:Price/cac:AllowanceCharge" priority="1004" mode="M16">
...
<xsl:apply-templates select="@*|*" mode="M16"/>
	...
	<!--RULE -->
<xsl:template match="cac:Price/cbc:BaseQuantity[@unitCode]" priority="1003" mode="M16">
...
<xsl:apply-templates select="@*|*" mode="M16"/>
	...
	<!--RULE -->
<xsl:template match="cbc:EndpointID[@schemeID = '0088'] | cac:PartyIdentification/cbc:ID[@schemeID = '0088'] | cbc:CompanyID[@schemeID = '0088']" priority="1002" mode="M16">
...
<xsl:apply-templates select="@*|*" mode="M16"/>
	...
	<!--RULE -->
<xsl:template match="cbc:EndpointID[@schemeID = '0192'] | cac:PartyIdentification/cbc:ID[@schemeID = '0192'] | cbc:CompanyID[@schemeID = '0192']" priority="1001" mode="M16">
...
<xsl:apply-templates select="@*|*" mode="M16"/>
	...
	<!--RULE -->
<xsl:template match="cbc:EndpointID[@schemeID = '0184'] | cac:PartyIdentification/cbc:ID[@schemeID = '0184'] | cbc:CompanyID[@schemeID = '0184']" priority="1000" mode="M16">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cac:AccountingSupplierParty/cac:Party[$supplierCountry = 'AU']" priority="1002" mode="M17">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cac:AccountingSupplierParty/cac:Party[$supplierCountry = 'AU']"/>

		<!--ASSERT -->
<xsl:choose>
<xsl:when test="(string-length(cac:PartyLegalEntity/cbc:CompanyID)&gt;=1 and cac:PartyLegalEntity/cbc:CompanyID/@schemeID = '0151')"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(string-length(cac:PartyLegalEntity/cbc:CompanyID)&gt;=1 and cac:PartyLegalEntity/cbc:CompanyID/@schemeID = '0151')">
...
<xsl:apply-templates select="@*|*" mode="M17"/>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingCustomerParty/cac:Party[$buyerCountry = 'AU']" priority="1001" mode="M17">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cac:AccountingCustomerParty/cac:Party[$buyerCountry = 'AU']"/>
...
<xsl:apply-templates select="@*|*" mode="M17"/>
	...
	<!--RULE -->
<xsl:template match="cbc:EndpointID[@schemeID = '0151'] | cac:PartyIdentification/cbc:ID[@schemeID = '0151'] | cbc:CompanyID[@schemeID = '0151']" priority="1000" mode="M17">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="matches(normalize-space(), '^[0-9]{11}$') and u:abn(normalize-space())">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cac:AccountingSupplierParty/cac:Party[$supplierCountry = 'NZ']" priority="1001" mode="M18">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cac:AccountingSupplierParty/cac:Party[$supplierCountry = 'NZ']"/>

		<!--ASSERT -->
<xsl:choose>
<xsl:when test="(string-length(cac:PartyLegalEntity/cbc:CompanyID)&gt;=1 and cac:PartyLegalEntity/cbc:CompanyID/@schemeID = '0088') "/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(string-length(cac:PartyLegalEntity/cbc:CompanyID)&gt;=1 and cac:PartyLegalEntity/cbc:CompanyID/@schemeID = '0088')">
...
<xsl:apply-templates select="@*|*" mode="M18"/>
	...
	<!--RULE -->
<xsl:template match="cac:AccountingCustomerParty/cac:Party[$buyerCountry = 'NZ']" priority="1000" mode="M18">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cac:AccountingCustomerParty/cac:Party[$buyerCountry = 'NZ']"/>
...
<xsl:variable name="eaid" select="tokenize('0002 0007 0009 0037 0060 0088 0096 0097 0106 0130 0135 0142 0151 0183 0184 0190 0191 0192 0193 0195 0196 0198 0199 0200 0201 0202 0204 9901 9906 9907 9910 9913 9914 9915 9918 9919 9920 9922 9923 9924 9925 9926 9927 9928 9929 9930 9931 9932 9933 9934 9935 9936 9937 9938 9939 9940 9941 9942 9943 9944 9945 9946 9947 9948 9949 9950 9951 9952 9953 9955 9956 9957 9958', '\s')"/>
	...
	<!--RULE -->
<xsl:template match="cbc:EmbeddedDocumentBinaryObject[@mimeCode]" priority="1008" mode="M19">
...
<xsl:apply-templates select="@*|*" mode="M19"/>
	...
	<!--RULE -->
<xsl:template match="cac:AllowanceCharge[cbc:ChargeIndicator = 'false']/cbc:AllowanceChargeReasonCode" priority="1007" mode="M19">
...
<xsl:apply-templates select="@*|*" mode="M19"/>
	...
	<!--RULE -->
<xsl:template match="cac:AllowanceCharge[cbc:ChargeIndicator = 'true']/cbc:AllowanceChargeReasonCode" priority="1006" mode="M19">
...
<xsl:apply-templates select="@*|*" mode="M19"/>
	...
	<!--RULE -->
<xsl:template match="cac:InvoicePeriod/cbc:DescriptionCode" priority="1005" mode="M19">
...
<xsl:apply-templates select="@*|*" mode="M19"/>
	...
	<!--RULE -->
<xsl:template match="cbc:Amount | cbc:BaseAmount | cbc:PriceAmount | cbc:TaxAmount | cbc:TaxableAmount | cbc:LineExtensionAmount | cbc:TaxExclusiveAmount | cbc:TaxInclusiveAmount | cbc:AllowanceTotalAmount | cbc:ChargeTotalAmount | cbc:PrepaidAmount | cbc:PayableRoundingAmount | cbc:PayableAmount" priority="1004" mode="M19">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$profile != '01' or (some $code in tokenize('389', '\s') satisfies normalize-space(text()) = $code)">
...
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$profile != '01' or (some $code in tokenize('261', '\s') satisfies normalize-space(text()) = $code)">
...
<xsl:apply-templates select="@*|*" mode="M19"/>
	...
	<!--RULE -->
<xsl:template match="cbc:IssueDate | cbc:DueDate | cbc:TaxPointDate | cbc:StartDate | cbc:EndDate | cbc:ActualDeliveryDate" priority="1001" mode="M19">
